...
class Login extends CI_Controller {
	...
	public function check_login(){
		...
		if($rs > 0){
			...
			redirect('/login/index?flag='.$rs, 'refresh');
		}
	}
	...
	public function company_ns_yycheck(){
		$this->login_model->company_ns_yycheck();
	}

	public function agent_ns_yycheck(){
		$this->login_model->agent_ns_yycheck();
	}
	...
	public function get_cap(){
		...
		$rs = $this->create_captchayy($vals);
		$this->session->set_flashdata('cap', $rs['word']);
	}

	function create_captchayy($data = '', $font_path = '')
